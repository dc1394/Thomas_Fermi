...
namespace thomasfermi {
	namespace shoot {
		load2::load2() : psplint(boost::none)
		{
			...
			x += 0.000, 0.010, 0.020, 0.030, 0.040, 0.050,
			...
			y += 1.000, 0.985, 0.972, 0.959, 0.947, 0.935,
			...
			psplint = boost::in_place(x, y);
		}

		shootfunc::tmpary load2::make_v2(double x2) const
		{
			shootfunc::tmpary v2 = { x2 > THRESHOLD ? load2::dphiT(x2) : psplint->df_dx(x2) };
			return v2;
		}
