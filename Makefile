...
#
CXXFLAGS = -Wextra -std=c++14 -xHOST -O3 -ipo -no-prec-div -I${MKLROOT}/include 

#
# リンク対象に含めるライブラリの指定
#
LDFLAGS = -L/home/dc1394/oss/boost_1_67_0/stage/icc/lib -L${MKLROOT}/lib/intel64 \
          -lboost_program_options -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core \
		  -liomp5 -lpthread -lgsl -ldl
#
# makeの動作
#
all: $(PROG) ;
