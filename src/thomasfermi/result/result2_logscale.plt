...
# set terminal windows 0 color solid butt
# set output
unset clip points
set clip one
unset clip two
...
set ylabel "Electron density" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 0.000100000 : 10.0000 ] noreverse nowriteback
...
set fontpath 
set psdir
set fit noerrorvariables errorscaling
GNUTERM = "windows"
p "result2.csv" u 1:2 w l title "Thomas-Fermi density","result2.csv" u 1:3 w l title "Exact density"
#    EOF
